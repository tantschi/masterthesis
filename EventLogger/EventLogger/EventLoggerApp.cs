        ...
        private void Execute()
        {
            ...
            try
            {
                while (true)
                {
                    ...
                    _log.WriteEntry(string.Format("TANJA IS MAL LUSTIG ! INFO (EventLoggerApp.Execute): Current time is: {0}.", DateTime.Now.ToString("HH:mm:ss")));
            ...
            {
                _log.WriteEntry("TANJA IS Noch lustigER! INFO (EventLoggerApp.Execute): Thread aborted.");
            }
        }
